...
namespace MultasProj.Controllers
{
    public class MultasController : Controller
    {
        ...
        {
            var multas = db.Multas.Where(m=>m.Agente.UserName.Equals(User.Identity.Name )).Include(m => m.Agente).Include(m => m.Condutor).Include(m => m.Viaturas);
        ...
        public ActionResult Create([Bind(Include = "ID,Infracao,LocalDaMulta,ValorMulta,DataDaMulta,AgenteFK,ViaturaFK,CondutorFK")] Multas multas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Infracao,LocalDaMulta,ValorMulta,DataDaMulta,AgenteFK,ViaturaFK,CondutorFK")] Multas multas)
        {
            if (ModelState.IsValid)
            {
